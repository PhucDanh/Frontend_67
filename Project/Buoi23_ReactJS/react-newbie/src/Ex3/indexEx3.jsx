...
export default class FilmExercise extends Component {
    movieList = [
        {
          maPhim: 1283,
          tenPhim: "Trainwreck",
    ...
    renderMovie = () => {
        const movieHTML = this.movieList.map((item) => {
            return (
                <div className="col-4">
                    <div className="card">
                ...
                <div className="row">
                    ...
                    {/* <div className="col-4">
                        <div className="card">
                            ...
                            <div className="card-body">
                                <h4>Home</h4>
                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Atque nisi ratione odio laborum laudantium porro molestiae ab, dolore earum labore, quisquam consequatur iusto accusantium deleniti, totam eaque quasi similique hic.</p>
                            </div>
                        </div>
                    </div> */}
                </div>
